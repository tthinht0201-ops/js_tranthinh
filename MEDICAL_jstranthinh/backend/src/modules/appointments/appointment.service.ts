...
import type {
  AdminAppointmentsQueryInput,
  AdminRescheduleAppointmentInput,
  AdminUpdateAppointmentStatusInput,
  CancelAppointmentInput,
  CreateAppointmentInput,
  DoctorAppointmentsQueryInput,
  PatientAppointmentsQueryInput,
...
const createAppointmentAttempt = async (
  userId: string,
...
export const getMyPatientAppointments = async (
  userId: string,
  query: PatientAppointmentsQueryInput,
) => {
...
export const getMyDoctorAppointments = async (
  userId: string,
  query: DoctorAppointmentsQueryInput,
) => {
...
export const completeMyDoctorAppointment = async (
  userId: string,
  appointmentId: string,
) => {
  const appointment = await prisma.appointment.findFirst({
...
export const getAllAppointments = async (
  query: AdminAppointmentsQueryInput,
) => {
  return prisma.appointment.findMany({
    where: {
...
export const updateAppointmentStatusByStaff = async (
  userId: string,
  appointmentId: string,
  ...
  const cancellationReason =
    cancellationSource === CancellationSource.DOCTOR
...
export const rescheduleAppointmentByStaff = async (
  appointmentId: string,
  ...
  return prisma.$transaction(
    async (tx) => {
      ...
      const schedule = await findValidSchedule(
        tx,
        doctor.id,
        startAt,
      );
