...
import {
  ...
  blockedTimeIdSchema,
  blockedTimeQuerySchema,
  createBlockedTimeSchema,
  createDateScheduleSchema,
  createScheduleSchema,
  dateScheduleIdSchema,
  scheduleIdSchema,
  updateBlockedTimeSchema,
  updateDateScheduleSchema,
  updateScheduleSchema,
} from "./schedule.schema.js";
import {
  createMyBlockedTime,
  createMyDateSchedule,
  createMySchedule,
  deleteMyBlockedTime,
  deleteMyDateSchedule,
  deleteMySchedule,
  getAvailableSlots,
  getMyBlockedTimes,
  getMyDateSchedules,
  getMySchedules,
  updateMyBlockedTime,
  updateMyDateSchedule,
  updateMySchedule,
} from "./schedule.service.js";

const handleScheduleError = (error: unknown, res: Response): boolean => {
...
export const createMyScheduleController = async (
  req: Request,
  res: Response,
) => {
  ...
  try {
    ...
    if (handleScheduleError(error, res)) return;
    throw error;
  }
};

export const updateMyScheduleController = async (
  req: Request,
  res: Response,
) => {
...
export const deleteMyScheduleController = async (
  req: Request,
  res: Response,
) => {
...
export const createMyDateScheduleController = async (
  req: Request,
  res: Response,
) => {
...
export const updateMyDateScheduleController = async (
  req: Request,
  res: Response,
) => {
  ...
  try {
    const data = await updateMyDateSchedule(
      currentUserId(req),
      params.data.id,
      body.data,
    );
...
export const deleteMyDateScheduleController = async (
  req: Request,
  res: Response,
) => {
...
export const createMyBlockedTimeController = async (
  req: Request,
  res: Response,
) => {
...
export const updateMyBlockedTimeController = async (
  req: Request,
  res: Response,
) => {
  ...
  try {
    const data = await updateMyBlockedTime(
      currentUserId(req),
      params.data.id,
      body.data,
    );
...
export const deleteMyBlockedTimeController = async (
  req: Request,
  res: Response,
) => {
