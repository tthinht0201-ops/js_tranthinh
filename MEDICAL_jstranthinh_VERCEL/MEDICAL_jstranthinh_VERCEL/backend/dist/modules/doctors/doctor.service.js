...
export const createDoctor = async (input) => {
    ...
    if (normalizedPhone) {
        const existingPhone = await prisma.doctorProfile.findUnique({
            where: {
...
export const updateDoctor = async (id, input) => {
    ...
    if (input.email !== undefined) {
        ...
        if (normalizedEmail !== doctor.user.email) {
...
export const deactivateDoctor = async (id) => {
    ...
    if (!doctor.user.isActive) {
        throw new Error("DOCTOR_ALREADY_INACTIVE");
    }
