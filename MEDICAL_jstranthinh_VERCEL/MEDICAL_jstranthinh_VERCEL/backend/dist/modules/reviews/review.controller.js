import { createReviewSchema, doctorReviewsParamsSchema, } from "./review.schema.js";
import { createReview, getDoctorReviews, } from "./review.service.js";
...
export const createReviewController = async (req, res) => {
    ...
    try {
        ...
        if (handleReviewError(error, res))
            return;
        throw error;
    }
};
