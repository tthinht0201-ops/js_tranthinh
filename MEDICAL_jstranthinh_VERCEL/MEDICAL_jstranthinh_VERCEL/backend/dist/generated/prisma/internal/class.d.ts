 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.doctorDateSchedule`: Exposes CRUD operations for the **DoctorDateSchedule** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more DoctorDateSchedules
      * const doctorDateSchedules = await prisma.doctorDateSchedule.findMany()
      * ```
      */
    get doctorDateSchedule(): Prisma.DoctorDateScheduleDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.blockedTime`: Exposes CRUD operations for the **BlockedTime** model.
      ...
      * ```
      */
    get blockedTime(): Prisma.BlockedTimeDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
